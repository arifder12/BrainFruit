  ...
  return (
    <View style={styles.container}>
      <View style={{display: 'block'}}>
         ...
         <Image
            source={require('../../assets/materi/MateriAlpukat.png')}
            style={{ width: 500, height: 300, marginBottom: 10, marginTop: 50, resizeMode:'contain'}}
          />
        </View>
        <TouchableOpacity
          style={styles.buttonTenseStyle}
          activeOpacity={0.5}  onPress={() => navigation.navigate('Materianggur')}>
          <Image
        ...
        <TouchableOpacity
          style={styles.buttonTenseStyle}
          activeOpacity={0.5}  onPress={() => navigation.navigate('Quizalpukat')}>
          <Image
